...
$(document).ready(function() {
  ...
  $("#newClientForm").validate({
    ...
    rules: {
      ...
      web:    { required:true,minlength:1,maxlength:50},
    ...
    messages: {
      name:   "Client name is required with maximum length of 50",
      web:    "Website is required with maximum length of 50",
      addr:   "Street address is required with maximum length of 50",
